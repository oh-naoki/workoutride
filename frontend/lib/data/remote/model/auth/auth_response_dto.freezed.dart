...
abstract class $AuthResponseDtoCopyWith<$Res> {
  ...
  @useResult
  $Res call({String token, String expires_at, UserDto user});
...
class _$AuthResponseDtoImpl implements _AuthResponseDto {
  const _$AuthResponseDtoImpl(
      {required this.token, required this.expires_at, required this.user});
  ...
  @override
  String toString() {
    return 'AuthResponseDto(token: $token, expires_at: $expires_at, user: $user)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, expires_at, user);
